...
namespace VideoGameOnlineShopInfrastructure.Repositories.Common
{
    public class BaseGenericRepository<T> : IBaseGenericRepository<T> where T : BaseEntity 
    {
        public readonly VideoGameOnlineShopDbContext dbContext;
        public readonly DbSet<T> _dbEntitySet;

        public BaseGenericRepository(VideoGameOnlineShopDbContext dbContext)
        {
